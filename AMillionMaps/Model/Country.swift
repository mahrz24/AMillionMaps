...
enum ISO3166_1_Alpha3CountryCode {
  case AFG // "Afghanistan", "AF", "AFG", "4", "33", "65"
  case ALB //  "Albania", "AL", "ALB", "8", "41", "20"
...
class Country: Identifiable {
  var id: ISO3166_1_Alpha3CountryCode
  
  init(id: ISO3166_1_Alpha3CountryCode, iSO3166_1_Alpha3CountryCode: String) {
    self.id = id
    self.iSO3166_1_Alpha3CountryCode = iSO3166_1_Alpha3CountryCode
  }
  ...
  var iSO3166_1_Alpha3CountryCode: String = ""
